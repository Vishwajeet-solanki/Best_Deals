...
def ama_discover_product_urls(url, HEADERS):
    ...
    for prod in ama_product_divs:
        ...
        if (total < 2):
            URL = "https://api.scrapingdog.com/scrape?api_key=66bf67cfffd578198598cfbf&url=" + \
...
def crawl2(request, stringextra):
    ...
    url = "https://api.scrapingdog.com/scrape?api_key=66bf67cfffd578198598cfbf&url=https://www.amazon.in/s?k=" + \
        stringextra+"&page=1/&dynamic=false"
    ama_discover_product_urls(url, HEADERS)
    url = "https://api.scrapingdog.com/scrape?api_key=66bf67cfffd578198598cfbf&url=https://www.flipkart.com/search?q="+stringextra+"&page=1&dynamic=false"
